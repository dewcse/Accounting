...
Modernizr.load({
  ...
  nope: '../Resources/Template/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['../Template/plugins/fix/ios-fix/ios-orientationchange-fix.js', '../Template/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
